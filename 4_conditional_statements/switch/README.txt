...
1) Read conditional statements upto switch statements , try the end of chapter exercises ( leave loops questions).
2) Read the operators chapter 
3) read the notes given
4) prepare for if else exam (lab test + written test)
